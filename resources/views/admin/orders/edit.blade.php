            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="receiver_address" id="receiver_address" class="form-control" rows="2" required placeholder="Nhập địa chỉ chi tiết sau khi chọn Tỉnh/Huyện/Xã" disabled>{{ old('receiver_address', $order->receiver_address) }}</textarea>
...
$(document).ready(function() {
    ...
    function loadDistrictsForProvince(provinceName, districtSelectId) {
        ...
        @if($order->receiver_district)
            $districtSelect.val('{{ $order->receiver_district }}').trigger('change');
        @endif
    }
